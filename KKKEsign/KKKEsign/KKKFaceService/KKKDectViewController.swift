...
//        self.navigationController?.navigationBar.hidden = false
    ...
    func addCanvas() -> Void {
        ...
        self.viewCanvas!.snp_makeConstraints { (make) -> Void in
            make.left.equalTo(previewView)
            make.right.equalTo(previewView)
            make.top.equalTo(previewView)
    ...
    func addSubViews()  {
        ...
        previewView.snp_makeConstraints { (make) -> Void in
        ...
        referFaceView = UIView()
        previewView.addSubview(referFaceView)
        referFaceView.snp_makeConstraints { (make) -> Void in
